...
agent = Agent(
    ...
    tools=[FileSearchTool(
        max_num_results=3, # set karne ka matlab hai, jab bhi koi query ki jaye, toh sirf 3 sab se relevant (best matching) results hi user ko milenge—not more, not less.
